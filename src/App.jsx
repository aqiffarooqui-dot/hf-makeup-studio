...
// =========================================================================
// THERMAL PERFORMANCE TOGGLE (GPU & HEATING CONTROL)
// Set to true  -> Enables original heavy 40px glass blur (may cause heating on S25 Ultra)
// Set to false -> Enables lightweight GPU rendering (keeps phone cool & battery safe)
// =========================================================================
const ENABLE_HEAVY_GLASS_BLUR = false;

const ACTIVE_BLUR_CLASS = ENABLE_HEAVY_GLASS_BLUR ? 'backdrop-blur-[40px]' : 'backdrop-blur-[16px]';
const ACTIVE_MODAL_BLUR = ENABLE_HEAVY_GLASS_BLUR ? 'backdrop-blur-[25px]' : 'backdrop-blur-[12px]';
    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 sm:p-6 text-center">
          <div className="max-w-md w-full bg-slate-900/90 backdrop-blur-[30px] border border-white/20 p-6 sm:p-8 rounded-[28px] sm:rounded-[36px] space-y-4 shadow-[0_32px_80px_rgba(0,0,0,0.7)]">
...
const THEME_STYLES = {
  admin_aurora: {
    night: {
      ...
      card: `bg-purple-950/20 ${ACTIVE_BLUR_CLASS} border border-purple-400/35 shadow-[0_24px_60px_rgba(168,85,247,0.18),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-purple-900/20 ${ACTIVE_BLUR_CLASS} border border-purple-400/30 shadow-inner`,
      ...
      pillBorder: `border border-purple-400/40 bg-purple-500/15 text-purple-200 ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-black/30 ${ACTIVE_BLUR_CLASS} border border-purple-400/35 text-white placeholder-slate-400 focus:border-purple-300 focus:bg-black/50`,
    ...
    day: {
      ...
      card: `bg-white/20 ${ACTIVE_BLUR_CLASS} border border-purple-300/60 shadow-[0_24px_60px_rgba(168,85,247,0.12),inset_0_2px_4px_rgba(255,255,255,0.9)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-white/25 ${ACTIVE_BLUR_CLASS} border border-purple-200/60 shadow-sm`,
      ...
      pillBorder: `border border-purple-400/70 bg-white/30 text-purple-950 font-black shadow-sm ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-white/30 ${ACTIVE_BLUR_CLASS} border border-purple-300/60 text-purple-950 placeholder-purple-400 focus:border-purple-600 focus:bg-white/50 shadow-inner font-medium`,
  ...
  sunset_glow: {
    night: {
      ...
      card: `bg-amber-950/20 ${ACTIVE_BLUR_CLASS} border border-amber-400/35 shadow-[0_24px_60px_rgba(245,158,11,0.18),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-amber-900/20 ${ACTIVE_BLUR_CLASS} border border-amber-400/30 shadow-inner`,
      ...
      pillBorder: `border border-amber-400/40 bg-amber-500/15 text-amber-200 ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-black/30 ${ACTIVE_BLUR_CLASS} border border-amber-400/35 text-white placeholder-slate-400 focus:border-amber-300 focus:bg-black/50`,
    ...
    day: {
      ...
      card: `bg-white/20 ${ACTIVE_BLUR_CLASS} border border-amber-300/60 shadow-[0_24px_60px_rgba(245,158,11,0.12),inset_0_2px_4px_rgba(255,255,255,0.9)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-white/25 ${ACTIVE_BLUR_CLASS} border border-amber-200/60 shadow-sm`,
      ...
      pillBorder: `border border-amber-400/70 bg-white/30 text-amber-950 font-black shadow-sm ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-white/30 ${ACTIVE_BLUR_CLASS} border border-amber-300/60 text-amber-950 placeholder-amber-400 focus:border-amber-600 focus:bg-white/50 shadow-inner font-medium`,
  ...
  cyber_matrix: {
    night: {
      ...
      card: `bg-cyan-950/20 ${ACTIVE_BLUR_CLASS} border border-cyan-400/35 shadow-[0_24px_60px_rgba(6,182,212,0.18),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-cyan-900/20 ${ACTIVE_BLUR_CLASS} border border-cyan-400/30 shadow-inner`,
      ...
      pillBorder: `border border-cyan-400/40 bg-cyan-500/15 text-cyan-200 ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-black/30 ${ACTIVE_BLUR_CLASS} border border-cyan-400/35 text-white placeholder-slate-400 focus:border-cyan-300 focus:bg-black/50`,
    ...
    day: {
      ...
      card: `bg-white/20 ${ACTIVE_BLUR_CLASS} border border-cyan-300/60 shadow-[0_24px_60px_rgba(6,182,212,0.12),inset_0_2px_4px_rgba(255,255,255,0.9)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-white/25 ${ACTIVE_BLUR_CLASS} border border-cyan-200/60 shadow-sm`,
      ...
      pillBorder: `border border-cyan-400/70 bg-white/30 text-cyan-950 font-black shadow-sm ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-white/30 ${ACTIVE_BLUR_CLASS} border border-cyan-300/60 text-cyan-950 placeholder-cyan-400 focus:border-cyan-600 focus:bg-white/50 shadow-inner font-medium`,
  ...
  real_glass_lens: {
    night: {
      ...
      card: `bg-blue-950/20 ${ACTIVE_BLUR_CLASS} border border-blue-400/35 shadow-[0_24px_60px_rgba(0,122,255,0.18),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-blue-900/20 ${ACTIVE_BLUR_CLASS} border border-blue-400/30 shadow-inner`,
      ...
      pillBorder: `border border-blue-400/40 bg-blue-500/15 text-blue-200 ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-black/30 ${ACTIVE_BLUR_CLASS} border border-blue-400/35 text-white placeholder-slate-400 focus:border-sky-300 focus:bg-black/50`,
    ...
    day: {
      ...
      card: `bg-white/20 ${ACTIVE_BLUR_CLASS} border border-blue-300/60 shadow-[0_24px_60px_rgba(0,122,255,0.12),inset_0_2px_4px_rgba(255,255,255,0.9)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-white/25 ${ACTIVE_BLUR_CLASS} border border-blue-200/60 shadow-sm`,
      ...
      pillBorder: `border border-blue-400/70 bg-white/30 text-blue-950 font-black shadow-sm ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-white/30 ${ACTIVE_BLUR_CLASS} border border-blue-300/60 text-blue-950 placeholder-blue-400 focus:border-blue-600 focus:bg-white/50 shadow-inner font-medium`,
  ...
  real_ios_glass: {
    night: {
      ...
      card: `bg-zinc-900/30 ${ACTIVE_BLUR_CLASS} border border-white/25 shadow-[0_24px_60px_rgba(0,0,0,0.6),inset_0_1.5px_2px_rgba(255,255,255,0.35)] rounded-[28px] sm:rounded-[36px]`,
      innerCard: `bg-white/[0.06] ${ACTIVE_BLUR_CLASS} border border-white/20 shadow-inner`,
      headingColor: "text-sky-300 drop-shadow-[0_2px_10px_rgba(56,189,248,0.4)]",
      tabActiveText: "text-sky-300 drop-shadow-[0_0_12px_rgba(56,189,248,0.9)]",
      accent: "text-sky-400",
      accentText: "text-sky-300 font-extrabold",
      pillBorder: `border border-sky-400/40 bg-sky-500/15 text-sky-200 ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-black/30 ${ACTIVE_BLUR_CLASS} border border-white/25 text-white placeholder-slate-400 focus:border-sky-300 focus:bg-black/50`,
    ...
    day: {
      ...
      card: `bg-white/20 ${ACTIVE_BLUR_CLASS} border border-slate-300/60 shadow-[0_24px_60px_rgba(15,23,42,0.1),inset_0_2px_4px_rgba(255,255,255,0.9)] rounded-[28px] sm:rounded-[36px]`,
      innerCard: `bg-white/25 ${ACTIVE_BLUR_CLASS} border border-slate-200/60 shadow-sm`,
      ...
      pillBorder: `border border-slate-400/70 bg-white/30 text-slate-950 font-black shadow-sm ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-white/30 ${ACTIVE_BLUR_CLASS} border border-slate-300/60 text-slate-950 placeholder-slate-400 focus:border-sky-600 focus:bg-white/50 shadow-inner font-medium`,
  ...
  liquid_glass: {
    night: {
      ...
      card: `bg-sky-950/20 ${ACTIVE_BLUR_CLASS} border border-cyan-400/35 shadow-[0_24px_60px_rgba(6,182,212,0.18),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-sky-900/20 ${ACTIVE_BLUR_CLASS} border border-cyan-400/30 shadow-inner`,
      headingColor: "text-cyan-300 drop-shadow-[0_2px_10px_rgba(6,182,212,0.4)]",
      tabActiveText: "text-cyan-300 drop-shadow-[0_0_12px_rgba(6,182,212,0.9)]",
      accent: "text-cyan-400",
      accentText: "text-cyan-300 font-extrabold",
  ...
  one_ui_9: {
    night: {
      ...
      card: `bg-zinc-900/35 ${ACTIVE_BLUR_CLASS} border border-zinc-500/40 shadow-[0_24px_60px_rgba(0,0,0,0.6),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[30px]`,
      innerCard: `bg-zinc-800/25 ${ACTIVE_BLUR_CLASS} border border-zinc-500/35 shadow-inner`,
      ...
      pillBorder: `border border-violet-400/40 bg-violet-500/15 text-violet-200 ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-black/30 ${ACTIVE_BLUR_CLASS} border border-zinc-500/40 text-white placeholder-slate-400 focus:border-violet-300 focus:bg-black/50`,
    ...
    day: {
      ...
      card: `bg-white/20 ${ACTIVE_BLUR_CLASS} border border-violet-300/60 shadow-[0_24px_60px_rgba(139,92,246,0.12),inset_0_2px_4px_rgba(255,255,255,0.9)] rounded-[28px] sm:rounded-[30px]`,
      innerCard: `bg-white/25 ${ACTIVE_BLUR_CLASS} border border-violet-200/60 shadow-sm`,
      ...
      pillBorder: `border border-violet-400/70 bg-white/30 text-violet-950 font-black shadow-sm ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-white/30 ${ACTIVE_BLUR_CLASS} border border-violet-300/60 text-violet-950 placeholder-violet-400 focus:border-violet-600 focus:bg-white/50 shadow-inner font-medium`,
  ...
  gold_rose: {
    night: {
      ...
      card: `bg-rose-950/20 ${ACTIVE_BLUR_CLASS} border border-amber-400/35 shadow-[0_24px_60px_rgba(244,63,94,0.18),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-rose-900/20 ${ACTIVE_BLUR_CLASS} border border-amber-400/30 shadow-inner`,
      ...
      accent: "text-amber-400",
      accentText: "text-amber-300 font-extrabold",
      pillBorder: `border border-rose-400/40 bg-rose-500/15 text-rose-200 ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-black/30 ${ACTIVE_BLUR_CLASS} border border-rose-400/35 text-white placeholder-slate-400 focus:border-rose-300 focus:bg-black/50`,
      glowOrb1: "radial-gradient(circle, rgba(245, 158, 11, 0.45) 0%, rgba(245, 158, 11, 0) 70%)",
      glowOrb2: "radial-gradient(circle, rgba(244, 63, 94, 0.38) 0%, rgba(244, 63, 94, 0) 70%)"
    },
    day: {
      bg: "bg-[#fff1f2] text-[#4c0519]",
      card: `bg-white/20 ${ACTIVE_BLUR_CLASS} border border-rose-300/60 shadow-[0_24px_60px_rgba(244,63,94,0.12),inset_0_2px_4px_rgba(255,255,255,0.9)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-white/25 ${ACTIVE_BLUR_CLASS} border border-rose-200/60 shadow-sm`,
      ...
      pillBorder: `border border-rose-400/70 bg-white/30 text-rose-950 font-black shadow-sm ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-white/30 ${ACTIVE_BLUR_CLASS} border border-rose-300/60 text-rose-950 placeholder-rose-400 focus:border-rose-600 focus:bg-white/50 shadow-inner font-medium`,
      glowOrb1: "radial-gradient(circle, rgba(245, 158, 11, 0.35) 0%, rgba(245, 158, 11, 0) 70%)",
      glowOrb2: "radial-gradient(circle, rgba(244, 63, 94, 0.3) 0%, rgba(244, 63, 94, 0) 70%)"
    }
  },
  champagne: {
    night: {
      ...
      card: `bg-orange-950/20 ${ACTIVE_BLUR_CLASS} border border-orange-400/35 shadow-[0_24px_60px_rgba(249,115,22,0.18),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-orange-900/20 ${ACTIVE_BLUR_CLASS} border border-orange-400/30 shadow-inner`,
      headingColor: "text-amber-300 drop-shadow-[0_2px_10px_rgba(245,158,11,0.4)]",
      tabActiveText: "text-amber-300 drop-shadow-[0_0_12px_rgba(245,158,11,0.9)]",
      accent: "text-amber-400",
      accentText: "text-amber-300 font-extrabold",
      pillBorder: `border border-orange-400/40 bg-orange-500/15 text-orange-200 ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-black/30 ${ACTIVE_BLUR_CLASS} border border-orange-400/35 text-white placeholder-slate-400 focus:border-amber-300 focus:bg-black/50`,
      glowOrb1: "radial-gradient(circle, rgba(245, 158, 11, 0.45) 0%, rgba(245, 158, 11, 0) 70%)",
      glowOrb2: "radial-gradient(circle, rgba(249, 115, 22, 0.35) 0%, rgba(249, 115, 22, 0) 70%)"
    },
    day: {
      bg: "bg-[#fff7ed] text-[#431407]",
      card: `bg-white/20 ${ACTIVE_BLUR_CLASS} border border-orange-300/60 shadow-[0_24px_60px_rgba(249,115,22,0.12),inset_0_2px_4px_rgba(255,255,255,0.9)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-white/25 ${ACTIVE_BLUR_CLASS} border border-orange-200/60 shadow-sm`,
      ...
      pillBorder: `border border-orange-400/70 bg-white/30 text-orange-950 font-black shadow-sm ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-white/30 ${ACTIVE_BLUR_CLASS} border border-orange-300/60 text-orange-950 placeholder-orange-400 focus:border-orange-600 focus:bg-white/50 shadow-inner font-medium`,
      glowOrb1: "radial-gradient(circle, rgba(245, 158, 11, 0.35) 0%, rgba(245, 158, 11, 0) 70%)",
  ...
  emerald: {
    night: {
      ...
      card: `bg-emerald-950/20 ${ACTIVE_BLUR_CLASS} border border-emerald-400/35 shadow-[0_24px_60px_rgba(168,85,247,0.18),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-emerald-900/20 ${ACTIVE_BLUR_CLASS} border border-emerald-400/30 shadow-inner`,
      ...
      pillBorder: `border border-emerald-400/40 bg-emerald-500/15 text-emerald-200 ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-black/30 ${ACTIVE_BLUR_CLASS} border border-emerald-400/35 text-white placeholder-slate-400 focus:border-emerald-300 focus:bg-black/50`,
    ...
    day: {
      ...
      card: `bg-white/20 ${ACTIVE_BLUR_CLASS} border border-emerald-300/60 shadow-[0_24px_60px_rgba(168,85,247,0.12),inset_0_2px_4px_rgba(255,255,255,0.9)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-white/25 ${ACTIVE_BLUR_CLASS} border border-emerald-200/60 shadow-sm`,
      ...
      pillBorder: `border border-emerald-400/70 bg-white/30 text-emerald-950 font-black shadow-sm ${ACTIVE_BLUR_CLASS}`,
      ...
      inputBg: `bg-white/30 ${ACTIVE_BLUR_CLASS} border border-emerald-300/60 text-emerald-950 placeholder-emerald-400 focus:border-emerald-600 focus:bg-white/50 shadow-inner font-medium`,
  ...
  ruby: {
    night: {
      ...
      card: `bg-rose-950/20 ${ACTIVE_BLUR_CLASS} border border-rose-400/35 shadow-[0_24px_60px_rgba(244,63,94,0.18),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-rose-900/20 ${ACTIVE_BLUR_CLASS} border border-rose-400/30 shadow-inner`,
      headingColor: "text-rose-300 drop-shadow-[0_2px_10px_rgba(244,63,94,0.4)]",
      tabActiveText: "text-rose-300 drop-shadow-[0_0_12px_rgba(244,63,94,0.9)]",
    ...
    day: {
      ...
      accent: "text-rose-700 font-bold",
      accentText: "text-rose-700 font-black",
      pillBorder: `border border-rose-400/70 bg-white/30 text-slate-950 font-black shadow-sm ${ACTIVE_BLUR_CLASS}`,
  ...
  sapphire: {
    night: {
      ...
      card: `bg-blue-950/20 ${ACTIVE_BLUR_CLASS} border border-blue-400/35 shadow-[0_24px_60px_rgba(37,99,235,0.18),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-blue-900/20 ${ACTIVE_BLUR_CLASS} border border-blue-400/30 shadow-inner`,
      ...
      inputBg: `bg-black/30 ${ACTIVE_BLUR_CLASS} border border-blue-400/35 text-white placeholder-slate-400 focus:border-blue-300 focus:bg-black/50`,
    ...
    day: {
      bg: "bg-[#eff6ff] text-[#1e3a8a]",
      card: `bg-white/20 ${ACTIVE_BLUR_CLASS} border border-blue-300/60 shadow-[0_24px_60px_rgba(37,99,235,0.12),inset_0_2px_4px_rgba(255,255,255,0.9)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-white/25 ${ACTIVE_BLUR_CLASS} border border-blue-200/60 shadow-sm`,
      headingColor: "text-blue-950 font-black drop-shadow-sm",
      tabActiveText: "text-blue-900 font-black drop-shadow-[0_0_10px_rgba(37,99,235,0.6)]",
      accent: "text-blue-700 font-bold",
      accentText: "text-blue-700 font-black",
      pillBorder: `border border-blue-400/70 bg-white/30 text-slate-950 font-black shadow-sm ${ACTIVE_BLUR_CLASS}`,
  ...
  default: {
    night: {
      bg: "bg-[#06070a] text-[#FFFFFF]",
      card: `bg-white/[0.06] ${ACTIVE_BLUR_CLASS} border border-white/25 shadow-[0_24px_60px_rgba(0,0,0,0.6),inset_0_1.5px_2px_rgba(255,255,255,0.25)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-white/[0.04] ${ACTIVE_BLUR_CLASS} border border-white/20 shadow-inner`,
      headingColor: "text-sky-300 drop-shadow-[0_2px_10px_rgba(56,189,248,0.4)]",
      tabActiveText: "text-sky-300 drop-shadow-[0_0_12px_rgba(56,189,248,0.9)]",
      accent: "text-sky-400",
      accentText: "text-sky-300 font-extrabold",
      pillBorder: `border border-white/30 bg-white/10 text-white ${ACTIVE_BLUR_CLASS}`,
    ...
    day: {
      bg: "bg-[#f8fafc] text-[#0f172a]",
      card: `bg-white/20 ${ACTIVE_BLUR_CLASS} border border-slate-300/60 shadow-[0_24px_60px_rgba(15,23,42,0.1),inset_0_2px_4px_rgba(255,255,255,0.9)] rounded-[28px] sm:rounded-[32px]`,
      innerCard: `bg-white/25 ${ACTIVE_BLUR_CLASS} border border-slate-200/60 shadow-sm`,
      headingColor: "text-slate-950 font-black drop-shadow-sm",
...
const CosmeticPreloader = ({ studioName, artistTagline, isDataLoaded }) => {
  return (
    <div className="fixed inset-0 z-[99999] bg-[#07060a] flex flex-col items-center justify-center p-6 select-none overflow-hidden">
      <div className="absolute w-80 h-80 rounded-full bg-pink-500/15 blur-[60px] pointer-events-none -top-12 -left-12" />
      ...
      <div className="relative flex flex-col items-center max-w-xs w-full text-center">
        ...
        <div className="relative w-32 h-32 flex items-center justify-center mb-6">
          ...
          <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-pink-950/70 via-purple-900/50 to-black/85 backdrop-blur-md border border-pink-400/50 shadow-[0_0_35px_rgba(236,72,153,0.4)] flex items-center justify-center">
...
function MainAppContent() {
  ...
  // LIGHTWEIGHT VISITOR LOGGING (RUNS ONCE PER LOAD: TRAFFIC SOURCE + DEVICE & BROWSER INFO + TOTAL VISIT)
  useEffect(() => {
    async function logVisitorTraffic() {
      try {
        ...
        await addDoc(collection(db, "visitor_logs"), {
          ...
          devicePlatform: deviceProfile.platform,
  ...
  if (config.isAppDown || config.maintenanceMode) {
    return (
      <div style={{ fontFamily: currentFontFamily }} className={`min-h-[100dvh] ${activeThemeStyle.bg} flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-300 ease-out`}>
        <div className="absolute top-1/4 left-1/4 w-80 sm:w-96 h-80 sm:h-96 rounded-full blur-3xl pointer-events-none" style={{ background: activeThemeStyle.glowOrb1 }} />
  ...
  return (
    ...
    >
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .hf-modal-backdrop { 
          ...
          background: rgba(0, 0, 0, 0.7); backdrop-filter: blur(18px); -webkit-backdrop-filter: blur(18px); overflow-y: auto; 
          transform: translateZ(0);
        }
      ...
      <div className="hf-ambient-backdrop">
        ...
        <div className="hf-mesh-glow w-[400px] sm:w-[600px] h-[400px] sm:h-[600px] -bottom-32 left-1/4 opacity-50" style={{ background: activeThemeStyle.glowOrb1 }} />
      </div>
      ...
      <div ref={topHeaderWrapperRef} className="fixed top-0 inset-x-0 z-40 hf-gpu-layer">
        {!showSplash && config.toggles?.enableAnnouncements !== false && config.showOfferSection !== false && (
          <div className={`w-full py-1.5 px-3 overflow-hidden text-[10px] sm:text-xs font-bold border-b shadow-sm ${isDarkMode ? 'bg-black/50 border-white/10 text-white backdrop-blur-[25px]' : 'bg-white/20 border-slate-300/60 text-slate-900 backdrop-blur-[25px]'}`}>
                        ...
                        {familyGuests.length > 0 ? (
                          <div className="space-y-2 pt-1 border-t border-purple-400/20">
                            {familyGuests.map((g, i) => {
                              ...
                              const gPkgName = config.kitText?.[g.kit]?.[g.packageKey]?.name || g.packageKey;
                              return (
                                <div key={i} className={`p-2.5 rounded-[14px] border border-purple-400/30 backdrop-blur-[15px] ${isDarkMode ? 'bg-purple-900/20 text-purple-200' : 'bg-purple-100/35 text-purple-950'} space-y-1 shadow-sm`}>
