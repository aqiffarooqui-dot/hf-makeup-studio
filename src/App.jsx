...
const THEME_STYLES = {
  ...
  liquid_glass: {
    night: {
      ...
      card: "bg-sky-950/25 backdrop-blur-[60px] border border-cyan-400/35 shadow-[0_24px_60px_rgba(6,182,212,0.18),inset_0_1.5px_2px_rgba(255,255,255,0.35)] rounded-[28px] sm:rounded-[32px]",
